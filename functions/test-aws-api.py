...
def get_ec2_instances_by_tag(region, tagkey, tagvalue):
    result = {}
    response = boto3.client('ec2', region).describe_instances(Filters=[{'Name': 'tag:'+tagkey, 'Values':[tagvalue]},
...
#   log.info('ec2 {}'.format(taggedEc2))
  ...
  for r in config_regions:
    ec2_instances = get_ec2_instances_by_tag(r, tagkey, tagvalue)
